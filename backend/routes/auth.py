...
#identity = {
    ...
    access_token = create_access_token(identity=str(user.phone_number), expires_delta=timedelta(minutes=15))
...
def refresh():
    ...
    new_access_token = create_access_token(identity=identity, expires_delta=timedelta(minutes=15)) #CHANGE TO STRING
